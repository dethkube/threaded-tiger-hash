...
/* Big endian:                                         */
    ...
    #define BIG_ENDIAN
  #else
    #if (defined(__x86_64__)||defined(__alpha)||defined(__i386__)||defined(__vax__))
    #else
      #if (defined(__sparc__))
        #define BIG_ENDIAN
      #else
        #warning Assuming your CPU is BIG ENDIAN.  This is probably wrong.  Fix the platform select macro definition to fix this problem.
      #endif
    #endif
  #endif
#endif
